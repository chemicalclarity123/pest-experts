...
const client = createClient({
    ...
    token: 'skg3ilUoFxBRfmAuRLQRcweY5W49fG12yoR4jDcmiXowQFJXjDu9nH8x9s7ezQEKfWRsxiCRFgOWtQEzA',
    useCdn: false,
});
...
async function updateServiceHighlights() {
...
updateServiceHighlights().catch(console.error);
